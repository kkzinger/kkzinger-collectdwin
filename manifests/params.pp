class conwin_collectdwin::params {
  ...
  $config_file_win_perfcounter ='C:\Program Files\Bloomberg LP\CollectdWin\config\WriteHttp.config',
  $config_file_write_http = 'C:\Program Files\Bloomberg LP\CollectdWin\config\WindowsPerformanceCounter.config',
}
